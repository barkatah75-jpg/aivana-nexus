# ===========================================
# 🚀 AIVANA_TODOLIST_AutoHeal_v10.2_FTPSAutoDetect.ps1
# (Stable: FTPS Auto-Heal + Telegram + Scheduler)
# ===========================================
...
function Run-AutoHeal {
  ...
  if ($ok -ge 5) {
    ...
    Send-Telegram "AIVANA AutoHeal Warning: Only $ok/$($langs.Count) online ⚠️"
