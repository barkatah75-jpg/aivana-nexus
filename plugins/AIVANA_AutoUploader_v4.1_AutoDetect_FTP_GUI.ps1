...
$ftpHosts = @("ftp://89.117.188.202/", "ftp://todolist.barkataiautomation.in/")
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        Title="AIVANA AutoUploader v4.1 - AutoDetect FTP" Height="370" Width="560" Background="#0a0a1f" WindowStartupLocation="CenterScreen">
  <Grid Margin="15">
...
$StartBtn.Add_Click({
    ...
    if (-not $pass) { Log "⚠️ Enter FTP password first!"; return }

    Log "=== AIVANA AutoUploader v4.1 Started ==="
    Log "📦 Creating ZIP..."
...
"@ | Set-Content $phpFile -Encoding UTF8
    ...
    Log "⬆️ Uploading files to $connectedHost ..."
    if (Upload-File $zipFile $connectedHost $pass -and Upload-File $phpFile $connectedHost $pass) {
        ...
        try {
            ...
            Log "⚠️ Extractor Error: $($_.Exception.Message)"
        }
        ...
        try {
            ...
            if ($res.StatusCode -eq 200) {
                ...
                Log "⚠️ HTTP Status: $($res.StatusCode)"
            }
        } catch {
